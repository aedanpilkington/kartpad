...
KartPad `v0.4.9` is an unsigned ARM64 IPA for iPhone and iPad. It is a free
...
1. Download `KartPad-v0.4.9-ios-unsigned.ipa` and `SHA256SUMS` from the
   [0.4.9 release](https://github.com/chrissotraidis/kartpad/releases/tag/v0.4.9).
