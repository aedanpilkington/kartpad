...
| iPhone/iPad 0.4.13/build 29 (intended) | Separate explicitly authorized manual release task owns build, merge, publication and README; no completed candidate declared here | Manual task was interrupted again by a connection timeout and asked to resume after checking existing work. Await exact artifact/source/audit handoff; scheduled coordinator never publishes IPA |
