...
| --- | --- | --- | --- |
| #105 rating companion restore | Medium source review cleared 10d44ee; corrected candidate packaged | Finish exact candidate notices/provenance review and integration; then request offline real-save testing | Android implementation; real-save acceptance pending, Apple parity not implemented |
...
| Android v0.4.13-android-preview.1 / code 28 | Local release-signed ARM64 Android 9+ candidate at cecd69c504f66aa0d8a40f485406618b9b616791; APK SHA-256 `e70ff84fb64ce52294ac13608530bdbed3e22395e5fab7a8ef85799c22de0607`. Not yet published | Medium rating source review cleared; 214 storage, 52 format and 66 Android contract checks reported passing; bundle-derived emulator Original rendering and 21 state files preserved. Final source, repeat signing, export/payload and public-signer emulator gates passed. PR #133 integration and anonymous release-download audit pending. Physical rating/performance acceptance pending; no test request sent for this candidate yet. Separate CPU context experiment excluded |
