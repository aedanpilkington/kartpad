...
| #123 online stalls and Pixel performance | Local investigation / owner device comparison | Queue independent review of Android-only scalar multiply context reuse (a396eda) before a matched game benchmark; keep separate from online-menu stalls. Owner reports 2704 physical semantic cases and host sanitizers; 66 Android contracts and fresh preparation differing only in the tested header pass; prototype multiply-only timing is not game FPS | Android; no proven freeze fix or FPS improvement percentage |
