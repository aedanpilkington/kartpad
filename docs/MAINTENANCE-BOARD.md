...
| iPhone/iPad 0.4.13/build 29 (intended) | Separate explicitly authorized manual release task owns build, merge, publication and README; no completed candidate declared here | Manual task resumed; retained M2-targeted artifact held pending reviewed physical-iOS baseline CPU correction and exact-source rebuild. Await exact artifact/source/audit handoff; scheduled coordinator never publishes IPA |
