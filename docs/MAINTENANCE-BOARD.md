...
| P2 #188 Mii import | Header-padding rejection reproduced and corrected in source; review/release/device test pending | [Source and regression evidence](artifacts/2026-09-10/issue188-mii-import.md): reporter supplied the exact rejection. Same synthetic 74-byte export fails in baseline JNI and passes after removing the false invalid-bit check; staged apply/backups and identity suites pass. AYN Thor import/name/appearance/restart acceptance remains; no new package or reporter confirmation. |
