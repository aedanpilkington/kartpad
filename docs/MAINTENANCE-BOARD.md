...
| [#206 discriminator requested](https://github.com/chrissotraidis/kartpad/issues/206#issuecomment-5640649659) | `requested`: exact failing milestone, pack version and matching short interval; no repeat request. Any acceptance must exceed the reported four/five-race failure window. |
