...
| P1 #104 / Adreno graphics | Code63 comparison returned unchanged; specific graphics investigation ready | [Reporter says unchanged](https://github.com/chrissotraidis/kartpad/issues/104#issuecomment-5620182067); acknowledged without repeat request. Isolate one actual draw/transform/shader/upload invariant. Keep #102 road textures and #166 broad corruption distinct until linked by mechanism. |
...
| P2 #188 Mii import | PR190 merged after independent Medium review; packaging and reporter test pending | [Source and regression evidence](artifacts/2026-09-10/issue188-mii-import.md): reporter supplied the exact rejection. Same synthetic 74-byte export fails in baseline JNI and passes after removing the false invalid-bit check; staged apply/backups and identity suites pass. AYN Thor import/name/appearance/restart acceptance remains; no new package or reporter confirmation. |
