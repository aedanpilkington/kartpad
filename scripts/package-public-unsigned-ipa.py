...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        nargs="?",
        help="Output IPA path (defaults to artifacts/KartPad-v0.4.10-ios-unsigned.ipa)",
    )
    ...
    output = (
        args.output.resolve()
        if args.output
        else repo / "artifacts/KartPad-v0.4.10-ios-unsigned.ipa"
    )
    ...
    additional_entries = {
        ...
        "RELEASE_NOTES.md": repo / "docs/releases/v0.4.10.md",
