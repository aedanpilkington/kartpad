...
export KARTPAD_ANDROID_EXPECTED_VERSION_NAME="${KARTPAD_ANDROID_EXPECTED_VERSION_NAME:-0.4.12-android.1}"
export KARTPAD_ANDROID_EXPECTED_VERSION_CODE="${KARTPAD_ANDROID_EXPECTED_VERSION_CODE:-22}"
